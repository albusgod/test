...
<html>
    <head>
        <meta http-equiv="REFRESH" content="0; URL=index.jsp"> <%--Esta linea devuelve automaticamente a Index despues de x seg--%>
                ...
                <div class="col-md-12">
                    ...
                    <div class="wrap">
                        ...
                        <form class="login" action="Ingresar">
                            ...
                            <input type="text" name="txtMonto" value="MONTO: <%=monto%>" />
                            <input type="text" name="txtFecha" value="<%=fecha%>" />
