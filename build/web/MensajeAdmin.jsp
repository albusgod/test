...
<html>
    <head>
        <meta http-equiv="REFRESH" content="4; URL=Administrador.jsp"> <%--Esta linea devuelve automaticamente a Index despues de x seg--%>
        ...
        <style> 
            body
            {
                background: url('https://artescritorio.com/wp-content/uploads/2016/11/comida-3.jpg') fixed;
                ...
                <div class="col-md-12">
                    ...
                    <div class="wrap">
                        <p class="form-title">
                            ...
                            <label> <h1>NO ES POSIBLE IMPRIMIR TICKET FUERA DE HORARIO.</h1></label>
